...
@section('main')
	    <div id="page-wrapper">
           ...
           <div class="row">
                <div class="col-md-12">
                   <h2 class="page-header"><span class="glyphicon glyphicon-user"></span>Profile <small>{{ $user->name }}</small>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
                                      <ul class="list-unstyled">
                                         ...
                                         <li>
                                            <span class="title"><span class="glyphicon glyphicon-envelope"></span>Mobile</span><br/>
                                            <span class="title-text">
                                                  <abbr title="Mobile">M: </abbr> +( {{ $user->country_code }} ) {{ $user->mobile }}
