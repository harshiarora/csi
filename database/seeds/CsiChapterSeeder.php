...
class CsiChapterSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$data = [
			['csi_state_code' => 'DL', 'name' => 'Delhi Chapter'],
			['csi_state_code' => 'HR', 'name' => 'Gurgaon Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Allahabad Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Ghaziabad Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Haridwar Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Jhansi Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Kanpur Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Lucknow Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Manakpur Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Mathura Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Noida Chapter'],
			['csi_state_code' => 'UP', 'name' => 'Varanasi Chapter'],
			['csi_state_code' => 'UT', 'name' => 'Dehradun Chapter'],
			['csi_state_code' => 'UT', 'name' => 'Haridwar Chapter'],
